...
import networkImg from '../assets/images/net.png';
...
const Home = () => {
  ...
  useEffect(() => {
    const filteredSaleProducts = products.filter((item) => item.sale === true);

    setHotSale(filteredSaleProducts);
  }, []);
                    ...
                    <p>
                      ...
                      <div className="hero__btns d-flex align-items-center gap-5 mt-4">
                        <button
                          ...
                          onClick={() => {
                            const section = document.getElementById('popular-food');
                ...
                <Col lg="6" md="6">
                  <div className="why__tasty-treat">
                    <h2 className="tasty__treat-title mb-4">
                      Why <span>Food Fusion?</span>
                    </h2>
                    <p className="tasty__treat-desc">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum, minus.
                      Tempora reprehenderit a corporis velit, laboriosam vitae ullam, repellat illo
                      sequi odio esse iste fugiat dolor, optio incidunt eligendi deleniti!
                    </p>
              ...
              <Row>
                <Col lg="6" md="6">
                  <div className="testimonial ">
                    <h5 className="testimonial__subtitle mb-4">Ratings</h5>
